 ...
 */
public class MyJFreeChartNumberAxis extends MyJFreeChartValueAxis{
     ...
     */
    public MyJFreeChartNumberAxis(String label) {
        super(label, MyJFreeChartNumberAxis.createStandardTickUnits());
   ...
   protected void selectHorizontalAutoTickUnit(Graphics2D g2,
    ...
    public Object clone() throws CloneNotSupportedException {
        MyJFreeChartNumberAxis clone = (MyJFreeChartNumberAxis) super.clone();
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof MyJFreeChartNumberAxis)) {
            return false;
        }
        MyJFreeChartNumberAxis that = (MyJFreeChartNumberAxis) obj;
